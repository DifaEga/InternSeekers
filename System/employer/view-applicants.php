...
<head>
	...
	<meta name="description" content="Internseekers / Job Portal" />
	<meta name="keywords" content="job, work, resume, applicants, application, employee, employer, hire, hiring, human resource management, hr, online job management, company, worker, career, recruiting, recruitment" />
	<meta name="author" content="Internseekers">
    ...
    <meta property="og:image:alt" content="Internseekers" />
    <meta property="og:description" content="Internseekers / Job Portal" />
  ...
  <style>
	...
	.blue-button {
      background-color: rgb(0, 193, 195);
      color: white;
      padding: 5px 50px;
	  width: 250px;
	  margin: 0;
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="../images/InternSeekers2.png" alt="Logo" /></a>
						</div>
					</div>
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="../job-list.php">Internship List</a>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="./">Home</a></li>
						<li><span>Applicants for the Internship <?php echo "$job_title"; ?></</span></li>
					</ol>
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title">Applicants for the  <?php echo "$job_title"; ?></</h3>
						</div>
								...
								?>
									...
									<div class="employee-grid-item">
										...
										<a target="_blank" href="../employee-detail.php?empid=<?php echo $rowb['member_no']; ?>" class="clearfix">
											...
											<a href="https://meetingsapac7.webex.com/webappng/sites/meetingsapac7/dashboard?siteurl=meetingsapac7" class="blue-button">Start Interview</a>
										</a>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-9">
								...
								<div class="col-sm-6 col-md-4">
									...
									<div class="footer-about-us">
										<h5 class="footer-title">About InternSeekers</h5>
										<p>InternSeekers is a portal to convinience student and an employers to get and advertising the internships.</p>
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											<li><a href="./">Home</a></li>
											<li><a href="job-list.php">Internship List</a></li>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">InternSeekers Contact</h5>
								
								<p>Address :  Universiti Teknologi Malaysia, Johor Bahru </p>
								<p>Email : <a href="egaadrian.difa@graduate.utm.my">egaadrian.difa@graduate.utm.my</a></p>
								<p>Phone : <a href="tel:+6281312022430">+62 813 1202 2430</a></p>
