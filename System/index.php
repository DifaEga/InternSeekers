...
<body class="home">
	...
	<div class="container-wrapper">
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/hero-bg.png');">
				<div class="container">

					<h1>your bright future starts here now</h1>
					<p>Get Your Internships with InternSeekers</p>
						...
						<div class="row">
							...
							<div class="col-sm-4">
								...
								<div class="process-item clearfix">
									...
									<div class="content">
										<h5>01 / Search for Internships</h5>
									</div>
