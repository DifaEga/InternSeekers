					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Universiti Teknologi Malaysia <br/> Johor Bahru <br/>skudai</address>
								</li>
								<li>
										<h5>Email</h5><a href="egaadrian.difa@graduate.utm.my">egaadrian.difa@graduate.utm.my</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+62 813 1202 2430">+62 813 1202 2430</a>
								</li>
